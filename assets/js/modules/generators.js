            ...
            if (sections.length > 0) {
              ...
              for (let idx = 0; idx < orderRegexps.length; idx++) {
                    ...
                    switch (idx) {
                      case 1: // Couleur primaire
                        {
                          ...
                          defaultLines.push(`  --primary-darken: var(${p700});`)
                        }
                        break
                      ...
                      case 5: // Interactions
                        if (themeMode === "both") {
                          ...
                          defaultLines.push("  --link: var(--primary-lighten);")
                      ...
                      case 11: // Espacements
                        if (spacingResponsive) {
                          defaultLines.push("  --spacing-xs: var(--spacing-4);")
                          defaultLines.push(
                            "  --spacing-s: clamp(var(--spacing-8), 0.2955rem + 0.9091vw, var(--spacing-16));",
                          )
                        } else {
                ...
                if (idx === 1) {
                  ...
                  for (const [k, arr] of propMap.entries()) ordered.push(...arr)
